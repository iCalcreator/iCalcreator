...
function iCal2XML( & $calendar ) {
  ...
  $xmlstr     = '<?xml version="1.0" encoding="utf-8"?><icalendar xmlns="urn:ietf:params:xml:ns:icalendar-2.0"></icalendar>';
  ...
  $journalProps  = array( 'dtstamp', 'uid',
                          ...
                          'description',
                          'exdate', 'related', 'rdate', 'request-status',
                          'x-prop' );
