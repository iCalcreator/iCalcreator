...
$e->setProperty( 'Dtstart', '20050428T110000 Eastern' );
$e->setProperty( 'Dtend', '20050428T120000 Eastern' );
$e->setProperty( 'Transp', 'OPAQUE' );
$e->setProperty( 'Rdate'
               , array( array( '20050428T110000 Eastern', '20050428T120000' )));
$e->setProperty( 'Recurrence-id', '20050428T130000Z' );
$e->setProperty( 'Comment'
               , "Another single instance reschedule - time only (+2 hrs)"
               , array( 'ALTREP' => 'CID:<FFFF__=0ABBE548DFE1F4C08f9e8a93d@coffeebean.com>' ));
...
$e->setProperty( 'Description'
               , 'body'
               , array( 'ALTREP' => 'CID:<FFFE__=0ABBE548DFE1F4C08f9e8a93d@coffeebean.com>'));
