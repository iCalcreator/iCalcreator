...
$o->setProperty( 'comment', '0a auto setting DEFAULT!!!' );

$o = & $c->newComponent( 'vevent' );
$o->setProperty( 'comment', '0b: 20010203T040506' );
$o->setProperty( 'Dtstamp', '20010203T040506' );
/**/
/**/
$o = & $c->newComponent( 'vevent' );
$dtstamp1 =                array( 'year'  => date( 'Y' )
                                 , 'month' => date( 'm' )
                                 , 'day'   => date( 'd' )
                                 , 'hour'  => date( 'H' )
                                 , 'min'   => date( 'i' )
                                 , 'sec'   => date( 's' )
                                 , 'tz'    => date( 'O' ));
$o->setProperty( 'dtstamp', $dtstamp1 );
$o->setProperty( 'comment', '0b  1='.implode( '-', $dtstamp1 ));
/**/
/**/
$o = & $c->newComponent( 'vevent' );
$o->setProperty( 'comment', "2: array( 'year' = 2006, 'month' => 10, 'day' => 10)" );
$o->setProperty( 'dtstamp', array( 'year' => 2006, 'month' => 10, 'day' => 10 ));
/**/
/**/
$o = & $c->newComponent( 'vevent' );
$o->setProperty( 'Dtstamp', 1, 2, 3 );
$o->setProperty( 'comment', '1: 1, 2, 3' );
/**/
/**/
$o = & $c->newComponent( 'vevent' );
$o->setProperty( 'dtstamp', 1, 2, 3, 4, 5, 6, array( 'xparam' ));
...
/**/
$o = & $c->newComponent( 'vevent' );
$o->setProperty( 'dtstamp', '2001-02-03 04:05:06', array( 'xparam', 'xparaMKey' => 'xparamValue' ) );
$o->setProperty( 'comment', "6: 2001-02-03 04:05:06, array( 'xparam', 'xparaMKey' => 'xparamValue' )" );
/**/
/**/
$o = & $c->newComponent( 'vevent' );
$o->setProperty( 'Dtstamp', '2001-02-03' );
$o->setProperty( 'comment', '7: 2001-02-03' );
/**/
/**/
$o = & $c->newComponent( 'vevent' );
$o->setProperty( 'dtstamp', '20010203' );
$o->setProperty( 'comment', '8: 20010203' );
/**/
/**/
$o = & $c->newComponent( 'vevent' );
$o->setProperty( 'dtstamp', '20010203040506' );
...
$o->setProperty( 'Dtstamp', '20010203T040506 Europe/Stockholm' );
/**/
/**/
$o = & $c->newComponent( 'vevent' );
$o->setProperty( 'dtstamp', '3 Feb 2001' );
$o->setProperty( 'comment', '10: 3 Feb 2001' );
/**/
/**/
$o = & $c->newComponent( 'vevent' );
$o->setProperty( 'dtstamp', '02/03/2001' );
$o->setProperty( 'comment', '11: 02/03/2001' );
/**/
/**/
$o = & $c->newComponent( 'vevent' );
$timestamp = mktime ( date('H'), date('i'), date('s'), date('m'), date('d'), date('Y'));
$o->setProperty( 'dtstamp', array( 'timestamp' => $timestamp ), array ( 'jestanes', 'xkey' => 'xvalue', 'xxx' => 'yyy' ) );
