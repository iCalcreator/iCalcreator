...
$o->setProperty( 'completed', '20010203T040506' );
/**/
/**/
$o = & $c->newComponent( 'vtodo' );
$completed1 =                array( 'year'  => date( 'Y' )
                                 , 'month' => date( 'm' )
                                 , 'day'   => date( 'd' )
                                 , 'hour'  => date( 'H' )
                                 , 'min'   => date( 'i' )
                                 , 'sec'   => date( 's' )
                                 , 'tz'    => date( 'O' ));
$o->setProperty( 'completed', $completed1 );
$o->setProperty( 'comment', '0b  1='.implode( '-', $completed1 ));
/**/
/**/
$o = & $c->newComponent( 'vtodo' );
$o->setProperty( 'comment', "2: array( 'year' = 2006, 'month' => 10, 'day' => 10)" );
$o->setProperty( 'completed', array( 'year' => 2006, 'month' => 10, 'day' => 10 ));
/**/
/**/
$o = & $c->newComponent( 'vtodo' );
$o->setProperty( 'completed', 1, 2, 3 );
$o->setProperty( 'comment', '1: 1, 2, 3' );
/**/
/**/
$o = & $c->newComponent( 'vtodo' );
$o->setProperty( 'completed', 1, 2, 3, 4, 5, 6, array( 'xparam' ));
...
/**/
$o = & $c->newComponent( 'vtodo' );
$o->setProperty( 'completed', '2001-02-03 04:05:06', array( 'xparam', 'xparaMKey' => 'xparamValue' ) );
$o->setProperty( 'comment', "6: 2001-02-03 04:05:06, array( 'xparam', 'xparaMKey' => 'xparamValue' )" );
/**/
/**/
$o = & $c->newComponent( 'vtodo' );
$o->setProperty( 'completed', '2001-02-03' );
$o->setProperty( 'comment', '7: 2001-02-03' );
/**/
/**/
$o = & $c->newComponent( 'vtodo' );
$o->setProperty( 'completed', '20010203' );
$o->setProperty( 'comment', '8: 20010203' );
/**/
/**/
$o = & $c->newComponent( 'vtodo' );
$o->setProperty( 'completed', '20010203040506' );
...
$o->setProperty( 'completed', '20010203T040506 Europe/Stockholm' );
/**/
/**/
$o = & $c->newComponent( 'vtodo' );
$o->setProperty( 'completed', '3 Feb 2001' );
$o->setProperty( 'comment', '10: 3 Feb 2001' );
/**/
/**/
$o = & $c->newComponent( 'vtodo' );
$o->setProperty( 'completed', '02/03/2001' );
$o->setProperty( 'comment', '11: 02/03/2001' );
/**/
/**/
$o = & $c->newComponent( 'vtodo' );
$timestamp = mktime ( date('H'), date('i'), date('s'), date('m'), date('d'), date('Y'));
$o->setProperty( 'completed', array( 'timestamp' => $timestamp ), array ( 'jestanes', 'xkey' => 'xvalue', 'xxx' => 'yyy' ) );
