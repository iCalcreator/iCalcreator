...
$e1 = & $e->newComponent( 'valarm' );
$e1->setProperty( 'attach', 'http://doclib.domain.net/lib1234567890/docfile1.txt' );

$e2 = & $e->newComponent( 'valarm' );
$e2->setProperty( 'attach', 'MIICajCCAdOgAwIBAgICBEUwDQYJKoZIhvcNAQEEBQAwdzELMAkGA1UEBhMCVVMxLDAqBgNVBAoTI05ldHNjYXBlIENvbW11bmljYXRpb25zIE.. .. .', array('FMTTYPE' => 'image/basic', 'ENCODING' => 'BASE64', 'VALUE' => 'BINARY', 'hejsan' ));
$e2->setProperty( 'attach', 'http://doclib.domain.net/lib1234567890/docfile2.txt', array( 'filetype' => 'text' ));
$e2->setProperty( 'attach'
                , 'http://doclib.domain.net/lib1234567890/docfile11.txt'
                , array( 'filetype' => 'text' )
                , 11 );
$e2->deleteProperty( 'attach', 11 );
