...
$o->setProperty( 'due', array( 2001, 2, 3 ));
...
$o->setProperty( 'due', array( 'day'=>3, 'month'=>2, 'year'=>1 ));
...
$o->setProperty( 'due', array( 2001, 2, 3, 4, 5, 6 ));
...
$o->setProperty( 'due', array( 2001, 2, 3, 4, 5, 6 ), array( 'VALUE' => 'DATE-TIME' ));

$o = & $c->newComponent( 'vevent' );
$o->setProperty( 'comment', 'A2d: long array( 2001, 2, 3, 4, 5, 6, "-0100" ),position replace key');
$o->setProperty( 'due', array( 2001, 2, 3, 4, 5, 6, '-0100' ));
...
$o->setProperty( 'due', array( 2001, 2, 3, 4, 5, 6, 'Europe/Stockholm' ));
...
$o->setProperty( 'due', '2001-02-03 04:05:06' );
...
$o->setProperty( 'due', '2001-02-03 04:05:06 US-Eastern' );

$o = & $c->newComponent( 'vevent' );
$o->setProperty( 'comment', 'C1b: 2001-02-03 04:05:06 US_Eastern' );
$o->setProperty( 'due', '2001-02-03 04:05:06 US_Eastern' );
...
$o->setProperty( 'due', '20010203T040506' );

$o = & $c->newComponent( 'vevent' );
$o->setProperty( 'comment', 'C6bb: 20110101T080000Z' );
$o->setProperty( 'due', '20110101T080000Z' );

$o = & $c->newComponent( 'vevent' );
$o->setProperty( 'comment', 'C6c: 20010203T040506 Europe/Stockholm' );
$o->setProperty( 'due', '20010203T040506 Europe/Stockholm' );

$o = & $c->newComponent( 'vevent' );
$o->setProperty( 'comment', 'C7: 3 Feb 2001 GMT' );
$o->setProperty( 'due', '3 Feb 2001 GMT' );
...
$o->setConfig( 'TZID', 'Europe/Rom' );
$o->setProperty( 'due', 2001, 2, 3, 4, 5, 6 );
...
$o->setProperty( 'due', 2006, 8, 11, 16, 30, 0, '-040000' ); // 11 august 2006 16.30.00 -040000
...
$o->setProperty( 'due', 2006, 8, 11, 16, 30, 0, '-040000', array( 'VALUE' => 'DATE-TIME' ) ); // 11 august 2006 16.30.00 -040000

$o = & $c->newComponent( 'vevent' );
$o->setProperty( 'comment', "D6: 2006, 8, 11, 16, 30, 0, 'Europe/Stockholm'" );
$o->setProperty( 'due', 2006, 8, 11, 16, 30, 0, 'Europe/Stockholm' ); // 11 august 2006 16.30.00 -040000
