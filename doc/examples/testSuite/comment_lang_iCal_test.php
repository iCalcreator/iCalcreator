...
$c->setProperty( 'x-comment', "language set at calendar level is 'en'" );
$c->setProperty( 'x-lang', "en" );

$e = & $c->newComponent( 'vevent' );
$e->setProperty( 'comment', "comment set with language:'se'", array( 'language' => 'se' ));

$e = & $c->newComponent( 'vevent' );
$e->setProperty( 'x-comment', "language set at component level is 'fr'" );
$e->setConfig( 'language' , 'fr' );
$e->setProperty( 'comment', "comment set without lang, will inherit language from component: 'fr'" );

$e = & $c->newComponent( 'vevent' );
$e->setProperty( 'comment', "comment set without lang, will inherit language from calendar: 'en'" );
