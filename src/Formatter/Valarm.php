...
use Kigkonsult\Icalcreator\Valarm as Source;
 ...
 */
final class Valarm extends FormatBase
{
    /**
    ...
    public static function format( CalendarComponent|Source $source ) : string
    {
        ...
        return
            ...
            Property\DurDates::format(
                self::TRIGGER,
                $source->getTrigger( true ),
                $allowEmpty
            ) .
            Property\DtxProperty::format(
                self::ACKNOWLEDGED,
                $source->getAcknowledged( true ),
                $allowEmpty
            ) .
